...
*** Python
**** Misc
Force rainbow delimiters in python:
#+begin_src emacs-lisp
...
#+RESULTS:
| doom--customize-themes-h-104 | doom--customize-themes-h-105 | doom--customize-themes-h-106 | doom--customize-themes-h-107 | doom--customize-themes-h-108 |
